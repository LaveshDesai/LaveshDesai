...
## 👨‍💻 Profile Summary
- **MSc Computing (AI) student** with a strong foundation in **Computer Engineering** and **AI/ML**
- Hands-on experience in **Python**, **AI/ML**, **NLP**, **Computer Vision**, **OCR**, **Data Analytics**, and **Data Preprocessing**
- Skilled in **end-to-end AI pipelines** including **pattern extraction and  prediction**
- Strong **problem-solving mindset**, **communication skills and confident**, and eagerness to learn in **fast-paced environments**
...
- Developed **computer vision systems** for **document, face, and license plate detection & recognition**, supporting **identity verification**
...
- Built **LLM-powered QA system** using **Qwen LLM**, **Hugging Face Transformers**, **PyTorch**
- Implemented **Retrieval-Augmented Generation (RAG)** with **BM25** over a **custom knowledge base**
- Optimized responses with **prompt engineering** & **few-shot learning**
- Led the team end-to-end within tight hackathon timelines
- **Skills:** **Large Language Models (LLM)** · **RAG** · **Prompt Engineering** · **Python**


### **SmartPremium – Health Insurance Risk Prediction**
- Analyzed **10+ health metrics** from **wearable (Fitbit) data**
- Generated **1,000+ synthetic records** using **Gaussian Copula** for balanced training
- Applied **K-Means**, **Logistic Regression**, **Random Forest**
- Achieved **94% prediction accuracy** for data-driven **insurance risk assessment**

### **Blinkit Data Analytics Dashboard**
- Developed **Power BI dashboards**: **Sales, Customers, Inventory, Feedback**
- Analyzed **5,000+ records**, built **DAX measures**, **interactive filters**, and **year-over-year comparisons**
...
### **Multi-Subject Knowledge QA System with Qwen 3.1** | *Oct 2025 – Dec 2025*  
Huawei Tech Arena Hackathon, Dublin, Ireland | Top 10 / 500+ Teams
- Led the team end-to-end to deliver **top solution** within timelines
- Built **LLM-powered QA system** using **Hugging Face Transformers, Qwen LLM, PyTorch**
- Implemented **RAG (BM25)** for context retrieval
...
- Led the team in **model development** & **documentation representation**
...
## 📫 Connect With Me
- **LinkedIn:** [Lavesh Desai](https://linkedin.com/in/lavesh-desai-488918337)  
- **YouTube:** [LoLLifeofLavesh](https://www.youtube.com/@LoLLifeofLavesh)  
- **Instagram:** [lavesh_._desai](https://instagram.com/lavesh_._desai)
